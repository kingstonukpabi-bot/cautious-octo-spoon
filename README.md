...
Complete your profile with age, gender, and sports preferences
Start exploring games on the map or host your own!
Hosting a Game
Click "Host Game" in the navigation
Fill in all game details:
Select the sport
...
Set date and time
Click "Host Game" to publish
Joining a Game
View games on the map or in the games list
Click on a game to see details
Click "Join Game" to participate
Adding Friends
Go to the Friends section
Search for users (feature can be extended)
